...
node('dora-slave') {
    ...
    def gitHubUrl = 'git@github.com:ca-cwds/dora.git'
    ...
    parameters([
        ...
        string(description: 'Fill this field if need to specify custom version ', name: 'hotfix_version'),
    ...
    try {
        stage('Preparation') {
            cleanWs()
            checkout changelog: false, poll: false, scm: [$class: 'GitSCM', branches: [[name: '$branch']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: github_credentials_id, url: gitHubUrl]]]
