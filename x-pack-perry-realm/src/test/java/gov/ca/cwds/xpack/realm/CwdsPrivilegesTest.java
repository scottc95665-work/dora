...
public class CwdsPrivilegesTest {
  ...
  public void testCwdsPrivileges() throws IOException {
    assertCwdsPrivileges("fixtures/jwtToken-test1.json", false, false, false, false, false, "1086");
    assertCwdsPrivileges("fixtures/jwtToken-test2.json", false,false, true, false, false, "1086");
    assertCwdsPrivileges("fixtures/jwtToken-test3.json", false,true, false, false, false, "1086");
    assertCwdsPrivileges("fixtures/jwtToken-test4.json", false,false, true, false, false, "1123");
    assertCwdsPrivileges("fixtures/jwtToken-test5.json", true,true, false, false, false, "1123");
    assertCwdsPrivileges("fixtures/jwtToken-test6.json", false,false, false, true, true, "1126");
  }
