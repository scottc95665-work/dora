...
public class IndexQueryResource {
  ...
  public Response searchIndex(
    ...
    IndexQueryRequest request = new IndexQueryRequestBuilder().addEndpoint(endpoint)
  ...
  private Response handleRequest(IndexQueryRequest request) {
    ...
    LOGGER
        .info("Elastic Search operation total time: {}", (System.currentTimeMillis() - startTime));
